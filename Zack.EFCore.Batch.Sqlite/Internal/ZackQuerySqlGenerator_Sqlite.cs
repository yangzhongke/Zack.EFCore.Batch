...
{
    class ZackQuerySqlGenerator_Sqlite : SqliteQuerySqlGenerator, IZackQuerySqlGenerator
    {
		/// <summary>
		...
		public ZackQuerySqlGenerator_Sqlite(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
			: base(dependencies)
		{
