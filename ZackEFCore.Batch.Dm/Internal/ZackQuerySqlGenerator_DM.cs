...
{
    class ZackQuerySqlGenerator_DM : DmQuerySqlGenerator, IZackQuerySqlGenerator
    {
		/// <summary>
		...
		public ZackQuerySqlGenerator_DM(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
			: base(dependencies)
		{
