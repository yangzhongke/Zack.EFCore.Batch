...
{
    class ZackQuerySqlGenerator_MSSQL : SqlServerQuerySqlGenerator, IZackQuerySqlGenerator
    {
		/// <summary>
		...
		public ZackQuerySqlGenerator_MSSQL(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
			: base(dependencies)
		{
