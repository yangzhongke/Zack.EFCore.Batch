...
namespace Demo.MSSQLServer.Migrations
{
    ...
    [Migration("20220805075254_SubOwnedType")]
    partial class SubOwnedType
    {
                    ...
                    b.OwnsOne("Demo.Base.MultiString", "Remarks", b1 =>
                        {
                            ...
                            b1.OwnsOne("Demo.Base.SubMultiString", "Second", b2 =>
                                {
                                    b2.Property<long>("MultiStringArticleId")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("bigint")
                                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                                    ...
                                    b2.HasKey("MultiStringArticleId");

                                    b2.ToTable("T_Articles");

                                    b2.WithOwner()
                                        .HasForeignKey("MultiStringArticleId");
                                });

                            b1.Navigation("Second")
                                .IsRequired();
                        });
